...
def load_backbone(backbone_type):
    ...
    if backbone_type == 'dinov2':
        ...
        model = CLIPModel.from_pretrained("/home/gridsan/manderson/ovdsat/weights/clip-vit-base-patch32")
        tokenizer = CLIPTokenizer.from_pretrained("/home/gridsan/manderson/ovdsat/weights/clip-vit-base-patch32")
